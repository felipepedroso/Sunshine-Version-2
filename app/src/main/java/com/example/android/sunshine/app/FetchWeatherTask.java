...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (cursor != null && cursor.moveToFirst() && cursor.getCount() > 0){
            int locationId = cursor.getInt(cursor.getColumnIndex(WeatherContract.LocationEntry._ID));
            return locationId;
        }
        ...
        Uri locationUri = contentResolver.insert(uri, values);
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                contentResolver.bulkInsert(WeatherEntry.CONTENT_URI, cVVector.toArray(weatherEntries));
            }
